...
import HomeAbout from "/src/assets/HomeAbout.png";
      ...
      <div className="container grid grid-cols-2 items-center justify-center py-20">
        <div className="relative z-0">
          <img
            ...
            alt="aboutus"
          />
          <div className="absolute z-0 -bottom-10 right-32 bg-bg rounded-xl p-10">
        ...
        <div>
          ...
          <button onClick={()=> HnadleNavigation("/about")} className="button font-DM sans">
            More About Us
          </button>
        </div>
      </div>
